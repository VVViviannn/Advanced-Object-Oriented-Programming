...
public class Die {
	...
	// valueMap = other.getValueMap();
	// faceValue = other.getValue();
	//// for (int i = 0; i < other.valueMap.size(); i++) {
	//// this.valueMap.put(i, other.valueMap.get(i));
	//// }
	// }
	public Die(Die other) {
		// if (other.getNumberOfFaces() == 0) {
		// throw new IllegalArgumentException();
		// }
		// valueMap = new TreeMap<>();
		for (int i = 1; i <= other.getNumberOfFaces(); i++) {
			valueMap.put(i, other.valueMap.get(i));
		}
		// this.currentValue = this.valueMap.get(1);
		faceValue = other.getValue();
	}
	...
	public String roll() {
		...
		faceValue = this.valueMap.get(rand.nextInt(getNumberOfFaces()) + 1);
		return faceValue;
	}
	 ...
	 */
	 ...
	 return (SortedMap<Integer, String>) ((TreeMap<Integer, String>)
	 valueMap).clone();
	 }
//	public SortedMap<Integer, String> getValueMap() {
//		Die other = new Die(this);
//		return other.valueMap;
//	}
	// public SortedMap<Integer, String> getValueMap() {
	// SortedMap<Integer, String> newMap = new TreeMap<Integer, String>();
	// for (int i = 1; i <= this.valueMap.size(); i++) {
	// newMap.put(i, this.valueMap.get(i - 1));
	// }
	// return newMap;
	// }
	...
	public int hashCode() {
		...
		for (int i = 0; i < valueMap.size(); i++) {
			result = result + valueMap.get(i + 1).hashCode();
		}
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!this.valueMap.containsValue(other.getValue())) {
			return false;
		}
		...
		for (int i = 1; i <= this.valueMap.size(); i++) {
			d1.add(this.valueMap.get(i));
			d2.add(other.valueMap.get(i));
		}
		Collections.sort(d1);
		Collections.sort(d2);
		boolean result = true;
		for (int i = 0; i < this.getNumberOfFaces() && result; i++) {
	...
	public String toString() {
		...
		for (int i = 0; i < valueMap.size() - 1; i++) {
			stringDie += (valueMap.get(i + 1) + ", ");
		}
		return stringDie + valueMap.get(valueMap.size());
	}
}
